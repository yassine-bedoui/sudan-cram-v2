  ...
  return (
    <aside className="w-64 border-r border-gray-200 overflow-y-auto bg-white">
        ...
        <div className="space-y-3">
          {indicators.map(indicator => (
            <button
              ...
              className={`w-full border p-3 text-left text-xs uppercase tracking-wide transition-colors font-medium rounded ${
      ...
      <div className="p-6 space-y-2">
        <button className="w-full border border-gray-300 bg-white text-gray-900 p-3 text-xs uppercase tracking-wide hover:bg-gray-50 hover:border-gray-400 transition-colors font-medium rounded">
